...
class GalleryAttachmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create gallery_attachment" do
    assert_difference('GalleryAttachment.count') do
      post gallery_attachments_url, params: { gallery_attachment: { picture: @gallery_attachment.picture, user_id: @gallery_attachment.user_id } }
    end
  ...
  test "should update gallery_attachment" do
    patch gallery_attachment_url(@gallery_attachment), params: { gallery_attachment: { picture: @gallery_attachment.picture, user_id: @gallery_attachment.user_id } }
